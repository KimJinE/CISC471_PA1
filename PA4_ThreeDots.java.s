...
/* epilogue start for Simple_greendot */
    ...
    .text
.global Simple_yellowdot
    .type  Simple_yellowdot, @function
Simple_yellowdot:
    push   r29
    push   r28
    # make space for locals and params
    ...
    std    Y + 3, r22
    std    Y + 4, r20
/* done with function Simple_yellowdot prologue */
...
/* epilogue start for Simple_yellowdot */
    # no return value
    # pop space off stack for parameters and locals
    pop    r30
    pop    r30
    ...
    pop    r29
    ret
    .size Simple_yellowdot, .-Simple_yellowdot
