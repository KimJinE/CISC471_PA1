...
Board_run:
    ...
    std    Y + 5, r18
    std    Y + 6, r16
/* done with function Board_run prologue */
    ...
    call    Board_displayboard

/* epilogue start for Board_run */
    # no return value
    ...
    pop    r29
    ret
    .size Board_run, .-Board_run


    .text
.global Board_displayboard
    .type  Board_displayboard, @function
Board_displayboard:
    push   r29
    push   r28
    # make space for locals and params
    ...
    std    Y + 4, r23
    std    Y + 3, r22
/* done with function Board_displayboard prologue */
...
/* epilogue start for Board_displayboard */
    # no return value
    # pop space off stack for parameters and locals
    pop    r30
    pop    r30
    ...
    pop    r29
    ret
    .size Board_displayboard, .-Board_displayboard
